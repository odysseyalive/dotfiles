;;; seashells-dark-theme.el --- Seashells Dark Theme -*- lexical-binding: t -*-
...
;;; Commentary:
;; A dark color theme based on the Seashells palette.

;;; Code:

(deftheme seashells-dark "Seashells dark color theme")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(lazy-highlight ((,class (:background ,teal :foreground ,fg-main))))
   ...
   `(secondary-selection ((,class (:background ,teal))))
   ...
   `(font-lock-constant-face ((,class (:foreground ,accent-light))))
   ...
   `(font-lock-type-face ((,class (:foreground ,accent-light))))
   ...
   `(org-level-2 ((,class (:foreground ,accent-light :weight bold :height 1.2))))
   ...
   `(org-verbatim ((,class (:foreground ,accent-light :background ,bg-alt))))
   ...
   `(diff-refine-added ((,class (:foreground ,green :background "#0d3d1d" :weight bold))))
   `(diff-refine-removed ((,class (:foreground ,red :background "#3d1d1d" :weight bold))))
   `(diff-refine-changed ((,class (:foreground ,orange :background "#3d3d1d" :weight bold))))
   ...
   `(ediff-fine-diff-A ((,class (:background "#3d1d1d" :weight bold))))
   `(ediff-fine-diff-B ((,class (:background "#0d3d1d" :weight bold))))
   `(ediff-fine-diff-C ((,class (:background "#3d3d1d" :weight bold))))
   ...
   `(magit-diff-hunk-heading-highlight ((,class (:foreground ,fg-main :background ,teal))))
   ...
   `(lsp-ui-peek-header ((,class (:background ,teal :foreground ,fg-main))))
   `(lsp-ui-peek-footer ((,class (:background ,teal))))
   ...
   `(orderless-match-face-2 ((,class (:foreground ,accent-light :weight bold))))
   ...
   `(doom-modeline-evil-operator-state ((,class (:foreground ,accent-light :weight bold))))
   ...
   `(avy-lead-face-1 ((,class (:background ,teal :foreground ,fg-main :weight bold))))
   ...
   `(rainbow-delimiters-depth-3-face ((,class (:foreground ,accent-light))))
   ...
   `(web-mode-html-attr-value-face ((,class (:foreground ,accent-light))))
   ...
   `(markdown-header-face-2 ((,class (:foreground ,accent-light :weight bold :height 1.2))))
   ...
   ;; Show-paren
   `(show-paren-match ((,class (:background ,teal :foreground ,fg-main :weight bold))))
...
(provide-theme 'seashells-dark)

;;; seashells-dark-theme.el ends here
