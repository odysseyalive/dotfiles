...
started stuttering to an unusable state. Then I stumbled onto [LazyVIM](https://www.lazyvim.org/).
...
index: [Tmux](#tmux), [Vim](#vim), [LazyVim](#lazyvim), [Kitty](#kitty), [Ghostty](#ghostty), [AeroSpace](#aerospace), [Hyprland](#hyprland), and [Ranger](#ranger)
